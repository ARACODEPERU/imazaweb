<section class="courses-one">
    <div class="container">
        <div class="section-title text-center">
            <span class="section-title__tagline">{{ $cursosArea[1]->content }}</span>
            <h2 class="section-title__title"> {{ $cursosArea[2]->content }}</h2>
        </div>
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="courses-one__single wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1000ms">
                    ...
                    <div class="courses-one__single-content">
                        <div class="courses-one__single-content-overlay-img">
                            <img src="{{ URL('themes/imazaweb/images/resources/courses-v1-overlay-img3.png') }}"
                                alt="" />
                        </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="courses-one__single wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1000ms">
                    ...
                    <div class="courses-one__single-content">
                        <div class="courses-one__single-content-overlay-img">
                            <img src="{{ URL('themes/imazaweb/images/resources/courses-v1-overlay-img4.png') }}"
                                alt="" />
                        </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="courses-one__single wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                    ...
                    <div class="courses-one__single-content">
                        <div class="courses-one__single-content-overlay-img">
                            <img src="{{ URL('themes/imazaweb/images/resources/courses-v1-overlay-img5.png') }}"
                                alt="" />
                        </div>
                        <h6 class="courses-one__single-content-name">Sarah Albert</h6>
                        <h4 class="courses-one__single-content-title"><a href="course-details.html">Become a
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="courses-one__single wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1000ms">
                    ...
                    <div class="courses-one__single-content">
                        <div class="courses-one__single-content-overlay-img">
                            <img src="{{ URL('themes/imazaweb/images/resources/courses-v1-overlay-img6.png') }}"
                                alt="" />
                        </div>
                        <h6 class="courses-one__single-content-name">Kevin Martin</h6>
                        <h4 class="courses-one__single-content-title"><a href="course-details.html">Become a
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="courses-one__single wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1000ms">
                    <div class="courses-one__single-img">
                        <img src="{{ URL('themes/imazaweb/images/resources/courses-v1-img7.jpg') }}"
                            alt="" />
                    </div>
                    <div class="courses-one__single-content">
                        <div class="courses-one__single-content-overlay-img">
                            <img src="{{ URL('themes/imazaweb/images/resources/courses-v1-overlay-img7.png') }}"
                                alt="" />
                        </div>
                        <h6 class="courses-one__single-content-name">Christine Eve</h6>
                        <h4 class="courses-one__single-content-title"><a href="course-details.html">Become a
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="courses-one__single wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1000ms">
                    ...
                    <div class="courses-one__single-content">
                        <div class="courses-one__single-content-overlay-img">
                            <img src="{{ URL('themes/imazaweb/images/resources/courses-v1-overlay-img8.png') }}"
                                alt="" />
                        </div>
                        <h6 class="courses-one__single-content-name">David Cooper</h6>
                        <h4 class="courses-one__single-content-title"><a href="course-details.html">Become a
