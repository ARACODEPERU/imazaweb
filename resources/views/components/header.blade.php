                                ...
                                <div class="main-menu__right-cart-search">
                                    <div class="main-menu__right-cart-box">
                                        <a href="{{ route('web_carrito') }}">
                                            ...
                                            <div id="contadorCarritoMovil" style="font-weight: 700; padding: 5px 7px; font-size: 16px; position: absolute; margin-top: -10px;">
                                    ...
                                    <div class="main-menu__right-search-box">
                                        <a href="{{ route('login') }}" target="_blank" class="thm-btn">Campus Virtual</a>
                                    </div>
                                </div>
                            </div>
                        </div>
