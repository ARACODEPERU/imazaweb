...
Route::put('/pagar/{id}', [WebPageController::class, 'processPayment'])->name('web_pagar');
...
Route::get('/gracias-compra/{id}', [WebPageController::class, 'graciasCompra'])->name('web_gracias_por_cursos');
